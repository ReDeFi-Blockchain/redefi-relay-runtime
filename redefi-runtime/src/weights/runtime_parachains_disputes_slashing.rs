...
impl<T: frame_system::Config> polkadot_runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost(n: u32, ) -> Weight {
		...
		//  Measured:  `5913 + n * (251 ±0)`
		//  Estimated: `9163 + n * (254 ±0)`
		// Minimum execution time: 96_660_000 picoseconds.
		Weight::from_parts(158_137_349, 0)
			.saturating_add(Weight::from_parts(0, 9163))
			// Standard Error: 3_296
			.saturating_add(Weight::from_parts(381_306, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(16))
			.saturating_add(T::DbWeight::get().writes(10))
			.saturating_add(Weight::from_parts(0, 254).saturating_mul(n.into()))
	}
}
